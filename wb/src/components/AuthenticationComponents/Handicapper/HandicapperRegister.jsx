        ...
        <div className="w-1/2 px-8 py-8">
          <form onSubmit={handleSubmit} className="space-y-1">
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border-b border-gray-300 py-2 focus:outline-none focus:border-pink-500 placeholder:text-sm"
                ...
                <div>
                  ...
                  <div className="flex justify-between gap-1">
                    <input
                      ...
                      onChange={handleChange}
                      className="w-[75%] border-b border-gray-300 py-2 focus:outline-none focus:border-pink-500 placeholder:text-sm"
                    ...
                    disabled={sendOtp === "Sending..."}
                      ...
                      className={`px-3 py-1 text-xs bg-pink-700 text-white cursor-pointer hover:opacity-80 transition ${sendOtp === "Sending..." ? "cursor-not-allowed opacity-60" : ""}`}
                    >
                      {sendOtp}
                    </button>
                  </div>
                ...
                <div className="flex justify-end py-3">
                  ...
                  type="button"
                  onClick={handleNext}
                  className="w-32 py-2 bg-pink-700 text-white text-sm hover:opacity-80 transition cursor-pointer"
                >
                  Next
                </button>
                </div>
              ...
              <>
                ...
                <div className="flex justify-between gap-4 py-4">
                  <button
                    type="button"
                    onClick={() => setStep(1)}
                    className="w-24 py-2 border border-gray-300 text-sm cursor-pointer hover:opacity-80 transition"
                  >
                    Back
                  </button>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-40 py-2 bg-pink-700 text-white text-sm hover:opacity-80 transition cursor-pointer"
                  >
            ...
            <p className="text-xs text-gray-600 text-center">
              ...
              <a href="/handicapper-login" className="text-pink-600 font-semibold">
                Login
              </a>
            </p>
...
export default HandicapperRegister;
